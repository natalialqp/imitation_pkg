...
class GaussianMixturePlotter:
    def __init__(self, robotName, actionName, angleId, n_components=10, covariance_type="full", max_iter=100, random_state=2):
    ...
    def plot_results(self, X, Y, avg_signal, means, covariances, index, title):
        ...
        # If there are still NaN values, use an imputer to handle them
